package pro.hs.videocreator.encoder;
...
public class EncodeDecode {
     ...
     */
    public boolean encodeDecodeVideoFromBufferToSurface(int width, int height, int bitRate) throws Throwable {
     ...
     */
    @SuppressLint("InlinedApi")
    private boolean doEncodeDecodeVideoFromBuffer(MediaCodec encoder, int encoderColorFormat) {
     ...
     *
     * @param endOfStream if this is the last frame
     * @param mBufferInfo the BufferInfo of data from encoder
     */
